...
\begin{figure}[!ht]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{associated_laguerre_alpha5.eps}}\quad
  \subfloat[][]{\includegraphics[width=.45\textwidth]{associated_laguerre.eps}}
...
\begin{figure}[!ht]
  \centering
  \subfloat[][]{\includegraphics[width=.4\textwidth]{lfit_order1_alpha2.eps}}\quad
  \subfloat[][]{\includegraphics[width=.4\textwidth]{lfit_order1_alpha4.eps}}\\
  \subfloat[][]{\includegraphics[width=.4\textwidth]{lfit_order4_alpha2.eps}}\quad
  \subfloat[][]{\includegraphics[width=.4\textwidth]{lfit_order4_alpha4.eps}}
